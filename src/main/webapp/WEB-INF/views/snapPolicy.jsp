...
<head>
    ...
    <script type="text/javascript" src="/static/js/snapPolicy.js"></script>
    <style type="text/css">
        .multieditbox{
            background: #f8f8f8;
...
<%--            <a href="#" class="easyui-linkbutton" id="emp_tb_edit"
            ...
            <a  href="#" class="easyui-linkbutton"
                data-options="iconCls:'icon-reload',plain:true" data-cmd="del">删除</a>
            <a  href="#" class="easyui-linkbutton"
            ...
            <div id="approval_tabs" class="easyui-tabs" style="width:100%;height:50%;">
                ...
                <div title="保单信息" style="padding:20px;display:none;">
                    ...
                    <table border="1px">
                        ...
                        <tr>
                            <td><input style="width:60px"  name="id"/></td>
