 ...
 --> <input type="text" name="email" />
	...
	<div id="emp_tb">
		...
		<a href="#" class="easyui-linkbutton"
			...
			data-cmd="del">删除</a> 
		<a href="#" class="easyui-linkbutton"
			data-options="iconCls:'icon-redo',plain:true" data-cmd="redo">导出列表</a>
				<a href="#" class="easyui-linkbutton"
			data-options="iconCls:'icon-reload',plain:true" data-cmd="reload">查询全部</a>
		</br>
		<!-- 关键字查询 -->
		关键字:<input type="text" name="keyword" /> 入职时间:<input type="text"
			name="beginDate" class="easyui-datebox">- <input type="text"
			name="endDate" class="easyui-datebox"> <a href="#"
