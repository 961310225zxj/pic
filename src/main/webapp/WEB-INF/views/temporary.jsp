...
<head>
    ...
    <script type="text/javascript" src="/static/js/temporary.js"></script>
    <style type="text/css">
        .multieditbox{
            background: #f8f8f8;
...
<div id="policy_tb" style="height:25px;line-height:25px;">
    ...
    <a  href="#" class="easyui-linkbutton"
        data-options="iconCls:'icon-reload',plain:true" data-cmd="cancels">取消接收</a>
</div>
    ...
    <div id="approval_tabs" class="easyui-tabs" style="width:100%;height:85%;">
        ...
        <div title="核保信息" style="padding:20px;display:none;">
            ...
            <form id="auditAdviceForm" method="post">
                ...
                <input name="suggestion" id="auditAdvice" class="easyui-textbox" data-options="multiline:true" style="width:100%;height: 70px;"><br/><br/>
