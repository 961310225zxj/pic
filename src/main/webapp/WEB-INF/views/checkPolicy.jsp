...
<head>
    ...
    <script type="text/javascript" src="/static/js/checkPolicy.js"></script>
    <style type="text/css">
        .multieditbox{
            background: #f8f8f8;
...
<body >
        ...
        <div id="policy_tb" style="height:25px;line-height:25px;">
            <a href="#" class="easyui-linkbutton"
               data-options="iconCls:'icon-add',plain:true" data-cmd="receive">接收</a>
            <a  href="#" class="easyui-linkbutton"
                data-options="iconCls:'icon-edit',plain:true" data-cmd="check">审核</a>
...
<%--        <div id="policy_dialog">
            ...
            <form id="policy_form" method="post">
                <input type="hidden" name="id" />
                        编号:<input class="basic-grey" type="text" name="" />
                        被保人:<input class="basic-grey" type="text" name="" />
                        投保人:<input class="basic-grey" type="text" name="" />
                        车主:<input class="basic-grey" type="text" name="" />
                        车辆信息: <input class="basic-grey" type="text" name="" />
                        产品:<input class="basic-grey" type="text" name="" />
                         <textarea class="multieditbox" style="width: 950px;height:300px;" placeholder="请输入审核意见...">
                         </textarea>
                        类型:
                        <select  class="easyui-combobox"  panelHeight='auto' style="width:170px;height:22px">
                            <option >退回</option>
                            <option >上报</option>
                            <option >同意</option>
                        </select>
        ...
        <fieldset class="test">
            ...
            <table style="margin-left: 170px">
                <tr>
                    <td> 提交日期:&nbsp;&nbsp;&nbsp;<input  name="inputtime"/></td>
                    <td>申请编号:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="id" style="text-align:center;border-radius:10px"/>
                    </td>
                </tr>
                <tr>
                    <td> 产品:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="product_combobox"
                                                                                               name="productId"/></td>
                    <td>投保人名称:&nbsp;&nbsp;&nbsp;<input name="clientName" style="text-align:center;border-radius:10px"/></td>
                </tr>
                <tr>
                    <td> 投保申请时间:&nbsp;&nbsp;&nbsp;<input name="beginDate" class="easyui-datebox"/> - <input name="endDate"
                    ...
                    <td>
                        <div>
                            <a class="easyui-linkbutton"
                               ...
                               onclick="">搜索</a>
                            <a class="easyui-linkbutton" data-options="iconCls:'icon-reload',plain:true" onclick="">刷新</a>
                            <a class="easyui-linkbutton" data-options="iconCls:'icon-redo',plain:true" onclick="">重置</a>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <div id="approval_tabs" class="easyui-tabs" style="width:100%;height:50%;">
                ...
                <div title="保单信息" style="padding:20px;display:none;">
                    ...
                    <table border="1px">
                        ...
                        <tr>
                            <td><input id="policyId" style="width:60px"  name="id"/></td>
                ...
                <div title="核保信息" style="padding:20px;display:none;">
                    ...
                    <form id="auditAdviceForm" method="post">
                        <input type="hidden" name="id">
                        <input id="auditAdvice" name="auditAdvice" class="easyui-textbox" data-options="multiline:true" style="width:100%;height: 70px;"><br/><br/>
                        <span style="font-family: 微软雅黑">核保选项:</span>
                        <select id="msg" name="msg">
                            <option value="2">同意</option>
                            <option value="3">上报</option>
                            <option value="5">拒保</option>
