...
public class EmployeeServiceImpl implements IEmployeeService {
	...
	public int insert(Employee record) {
		...
		//System.err.println(new Md5Hash(record.getPassword(),record.getUsername()).toString());
	...
	public List<Employee> exportEmployee() {
		return mapper.exportEmployee();
	}

	@Override
	public void updateByEmpPwd(String newpwd,Long empId) {
		mapper.updateByEmpPwd(newpwd,empId);
