...
public class CodeGenerator {
	...
	static{
		try {
			//设置文件模板目录在什么地方
			conf.setDirectoryForTemplateLoading(new File("E:/picc/templates"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	public static void main(String[] args) throws Exception{
		//codeGenerator(Student.class);
	...
	private static void codeGenerator(Class clazz) throws Exception {
		...
		//数据模型
		genertor.ClassInfo classInfo = new genertor.ClassInfo(clazz);
		//生成Mapper
	 ...
	 */
	private static void createFile(String templateName, String outPath, genertor.ClassInfo classInfo) throws Exception{
